...
class VideoRecorder:
    def __init__(self, width=640, height=360, fps=90, duration_seconds=10, output_dir='recordings'):
        ...
        self.frame_queue = queue.Queue(maxsize=500)  # Limit queue size to prevent memory issues
...
def main():
    recorder = VideoRecorder(duration_seconds=10, fps=90)
