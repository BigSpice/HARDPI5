...
try:
    ...
    required_packages = ["RPi.GPIO","aiofiles","aiocsv", "asyncio", "asgiref", "serial", "configparser"]
            ...
            while self.running == True:
                ...
                if ser.in_waiting > 0:
                    ...
                    try:
                        ...
                        if is_hit and self.USE_PEZO_TRIGGER == True:
                            HOLD_DATA = Data_Out
...
â–â–Œ â–â–Œâ–â–Œ â–â–Œâ–â–Œ   â–â–Œ â–â–Œâ–â–Œ â–â–Œ    â–â–Œ    â–â–šâ–žâ–˜â–â–Œ   
â–â–›â–€â–œâ–Œâ–â–›â–€â–œâ–Œ â–â–€â–šâ––â–â–›â–€â–šâ––â–â–›â–€â–œâ–Œ     â–â–€â–šâ––  â–â–Œ  â–â–€â–šâ––
â–â–Œ â–â–Œâ–â–Œ â–â–Œâ–—â–„â–„â–žâ–˜â–â–Œ â–â–Œâ–â–Œ â–â–Œ    â–—â–„â–„â–žâ–˜  â–â–Œ â–—â–„â–„â–žâ–˜
    """)
